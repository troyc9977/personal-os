...
- `decisions/NNNN-*.md` — Architecture Decision Records, numbered 0001+. Index in `decisions/README.md`. Template in `decisions/template.md`. Currently 0001–0011. Next available: 0012.
